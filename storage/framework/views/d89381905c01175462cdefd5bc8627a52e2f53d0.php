...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(url('/export')); ?>" method="get" enctype="multipart/form-data">
        <section class="news-text">
            ...
            <div class="details-center-right">
                <div class="detailsTitle">
                    ...
                    <input type="hidden" id="img_id" name="event_id" value="<?php echo e($id); ?>">
                </div>
...
<?php $__env->startSection('pageEnd'); ?>
    @parent
    <script type="text/javascript" src="<?php echo e(asset('js/highcharts-more.js')); ?>"></script>
