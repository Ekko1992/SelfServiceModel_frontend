<?php $__env->startSection('content'); ?>
            ...
            <div class="recent-event">
                <div class="recent-event-upload">
                    ...
                    <a href="<?php echo e(url('upload')); ?>">
                        <img src="<?php echo e(asset('image/newevent_button.png')); ?>" alt="">
                    </a>
                </div>
                <ul class="clickEvent">
    ...
    <section class="promptProgress">
        ...
        <div class="promptText">
            ...
            <img class="loader" src="<?php echo e(asset('image/map.png')); ?>" alt="">
            <img class="promptSetting" src="<?php echo e(asset('image/setting.jpg')); ?>" alt="">
...
<?php $__env->startSection('pageEnd'); ?>
    @parent
    <script type="text/javascript" src="<?php echo e(asset('js/goalProgress.js')); ?>"></script>
    <script>
        $(function(){
                ...
                success:function(data){
                    $.each(data.round,function (key,val) {
                        var html = "<li id='" + val.id + "' class='recent"+val.id+"'>" +
                            ...
                            "<img class='imgClick' src='<?php echo e(asset('image/delete.png')); ?>' alt=''>" +
                            "<a> </a>"+
                            "</div>" +
                            "</li>";
