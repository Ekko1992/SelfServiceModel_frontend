...
<div style="width: 650px;height: auto;margin: 30px auto;">
    ...
    <a style="margin-top: 20px;font-size: 16px; color: red;" href="<?php echo e($link = url('password/reset', $token).'?email='.urlencode($user->getEmailForPasswordReset())); ?>">点击链接即可进入修改密码</a>
